...
class _InputProfilScreenState extends State<InputProfilScreen> {
  ...
  void _simpanDanLanjut() {
    if (_formKey.currentState!.validate()) {
      ...
      // 1. Simpan Data Input ke Singleton
      ...
      // 2. LOGIKA HITUNG BMR (Mifflin-St Jeor) SESUAI FLOWCHART
      double bmr = (10 * appData.beratBadan) + (6.25 * appData.tinggiBadan) - (5 * appData.usia);
      ...
      // 3. HITUNG TOTAL ENERGI HARIAN (TDEE)
      // BMR dikali Faktor Aktivitas
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: SingleChildScrollView( // Pake Scroll biar gak mentok keyboard
        ...
        child: Form(
          ...
          child: Column(
            ...
            children: [
              const Text("Data ini digunakan untuk menghitung kebutuhan gizimu.", style: TextStyle(color: Colors.grey)),
                ...
                children: [
                  Expanded(
                    child: TextFormField(
                      ...
                      decoration: const InputDecoration(labelText: "Usia (th)", border: OutlineInputBorder()),
              ...
              SizedBox(
                ...
                child: ElevatedButton(
                  ...
                  child: const Text("HITUNG KEBUTUHAN GIZI", style: TextStyle(fontWeight: FontWeight.bold)),
                ),
              )
            ],
          ),
